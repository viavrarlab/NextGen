...
public class MaskMaker : EditorWindow {
    ...
    private void OnGUI()
    {
        ...
        else
        {
            ...
            {
                if(!previewMat)
                    previewMat = new Material(Shader.Find("Lightweight Render Pipeline/Lit"));
    ...
    private void PackTextures()
    {
        ...
        var path = EditorUtility.SaveFilePanelInProject("Save Texture To Diectory", "_LitMask", "png", "Saved");
